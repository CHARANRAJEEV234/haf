...
var x = setInterval(function(){
    ...
    document.getElementById("dateShow").innerHTML=`${today.getDate()}/${today.getMonth()+1}/${today.getFullYear()} 11:15 AM`;
  if(distance<=0){
    clearInterval(x);
...
<div id="demo"></div>`
   var c =document.getElementById('demo').innerHTML='<iframe width="100%" height="315" fullscreen src="https://www.youtube.com/embed/MC1zxuKpUIg"></iframe>';
...
var x = setInterval(function(){
    ...
    document.getElementById("minutes").innerHTML=minutes;
    document.getElementById("seconds").innerHTML=seconds;
      document.getElementById("dateShow").innerHTML=`${nextDate(0).getDate()}/${nextDate(0).getMonth()+1}/${nextDate(0).getFullYear()} 11:15 AM`
...
//     }
  if(distance<=0){
    clearInterval(x);
   var c =document.getElementById('demo').innerHTML='<iframe width="100%" height="315" src="https://www.youtube.com/embed/MC1zxuKpUIg"></iframe>';
